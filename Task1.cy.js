    ...
    it('check navigate customer service page',function() {
        const customerSevice = new CustomerServicePage();
          homePage.clickCustomerServiceTab();
            customerSevice.textTitle().should('eq',"Welcome to Amazon Customer Service");//checkin if im on the right page
  ...
  it('search field and track your package',function() {
    ...
    const searchPage = new SearchPage();
          ...
          searchPage.texttitleTrackYourPackage().should('eq'," Tracking your package");//checkin if im on the right page
